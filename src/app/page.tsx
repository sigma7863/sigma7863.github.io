    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-indigo-200 p-4 flex justify-between items-center">
        ...
        <nav className="flex gap-6 text-gray-600">
          ...
          <Link href="/works" className="hover:text-gray-900">
            works
          </Link>
      ...
      {/* Main Content */}
      <main className="flex-1 bg-blue-900 text-white">
          ...
          <div className="mb-16">
            ...
            <ul className="space-y-6">
              ...
              <li>
                <div className="flex items-center gap-2">
                  <span className="text-xl">•</span>
                  <span className="text-xl">ネットサーフィン</span>
                </div>
                <p className="ml-6">暇な時はずっとYouTubeを見ている</p>
              </li>
              <li>
                <div className="flex items-center gap-2">
                  <span className="text-xl">•</span>
                ...
                <p className="ml-6">慣性でスプラトゥーン・マリオカートをしている</p>
              </li>
              <li>
                <div className="flex items-center gap-2">
                  <span className="text-xl">•</span>
                ...
                <p className="ml-6">金欠により本が買えない</p>
              </li>
            </ul>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="flex flex-col items-center">
                ...
                <p className="text-center">@jq_6432</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-center">ido7863</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 flex items-center justify-center">
                  <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center">
                    <div className="w-8 h-8 bg-blue-500 rounded-tl-full rounded-tr-full"></div>
                  </div>
                </div>
      ...
      <footer className="bg-blue-900 text-white text-center py-4">
        <p>© 2025 Sigma7863 Built with Next.js • Tailwind CSS •</p>
      </footer>
    </div>
  )
}
